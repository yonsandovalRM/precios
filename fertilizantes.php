...
<body>
    ...
    <div id="principal">
        ...
        <div id="navegacion">
          <h6><a href="index.php">Home</a><i class="glyphicon glyphicon-chevron-right"></i> Análisis <i class="glyphicon glyphicon-chevron-right"></i><span> Fertilizantes orgánicos / Kits / Otros</span></h6>
        </div>
        <div id="contenido">
            <div class="row">
                <div class="col-xs-12">
                    <h3>Fertilizantes orgánicos / Kits / Otros</h3>
                    <div class="col-xs-12">
                        <br>
                        <p>Análisis de fertilizantes orgánicos (NCh/2880)</p>
                    </div>
                    <div class="col-xs-9">    
                        <br>
                        <div class="cajaazul">
                            <p>Sustratos – Compost – Tierras de hojas – Guanos, etc.</p>
                            <p>Análisis de nemátodos.</p>
                            <p>Servicio de muestreos.</p>
                            <p>Kit para determinaciones en packing.</p>
                        </div>
                        <br>
                        <div class="goto">
                            <ul>
