...
<body>
    ...
    <div id="principal">
        ...
        <div id="navegacion">
          <h6><a href="index.php">Home</a><i class="glyphicon glyphicon-chevron-right"></i> Análisis <i class="glyphicon glyphicon-chevron-right"></i><span> Fitopatológicos</span></h6>
        </div>
        <div id="contenido">
            <div class="row">
                <div class="col-xs-12">
